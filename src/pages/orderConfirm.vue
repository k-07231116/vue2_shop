  ...
  <div class="order-confirm">
          ...
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div
                ...
                :key="item.id"
                :class="{ checked: index === checkedAddressIndex }"
              ...
              <div class="addr-add" @click="editAddress({}, 'add')">
    ...
    >
      <template v-slot:body>
        <!-- 删除 -->
        <p v-if="userAction === 'delete'">您确认删除此地址吗</p>
        <!-- 新增 -->
...
export default {
  ...
  methods: {
    ...
    submitModal() {
      ...
      if (userAction === 'edit' || userAction === 'add') {
        let {
          receiverName,
          receiverMobile,
          receiverProvince,
    ...
    getCartList() {
      this.axios.get('/carts').then((res) => {
        let list = res.cartProductVoList //购物车所有数据
    ...
    // 订单提交
    orderSubmit() {
      if (this.checkedAddressIndex === null) {
